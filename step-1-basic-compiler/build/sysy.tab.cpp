...
#line 7 "/root/compiler/step-1-basic-compiler/src/sysy.y"
...
#line 86 "/root/compiler/step-1-basic-compiler/build/sysy.tab.cpp"
...
#line 50 "/root/compiler/step-1-basic-compiler/src/sysy.y"
            {
    auto comp_unit = make_unique<CompUnit>();
    comp_unit->func_def = unique_ptr<BaseAST>((yyvsp[0].ast_val));
    ast = std::move(comp_unit);
  }
#line 1090 "/root/compiler/step-1-basic-compiler/build/sysy.tab.cpp"
    break;

  case 3: /* FuncDef: FuncType IDENT '(' ')' Block  */
#line 58 "/root/compiler/step-1-basic-compiler/src/sysy.y"
                                 {
...
#line 1102 "/root/compiler/step-1-basic-compiler/build/sysy.tab.cpp"
    break;

  case 4: /* FuncType: INT  */
#line 69 "/root/compiler/step-1-basic-compiler/src/sysy.y"
        {
    auto ast = new FuncType();
    ast->functype = make_unique<string>("int");
    (yyval.ast_val) = ast;
  }
#line 1112 "/root/compiler/step-1-basic-compiler/build/sysy.tab.cpp"
    break;

  case 5: /* Block: '{' Stmt '}'  */
#line 77 "/root/compiler/step-1-basic-compiler/src/sysy.y"
                 {
    auto ast = new Block();
    ast->stmt = unique_ptr<BaseAST>((yyvsp[-1].ast_val));
    (yyval.ast_val) = ast;
  }
#line 1122 "/root/compiler/step-1-basic-compiler/build/sysy.tab.cpp"
    break;

  case 6: /* Stmt: RETURN Number ';'  */
#line 85 "/root/compiler/step-1-basic-compiler/src/sysy.y"
                      {
    auto ast = new Stmt();
    ast->number = unique_ptr<BaseAST>((yyvsp[-1].ast_val));
    (yyval.ast_val) = ast;
  }
#line 1132 "/root/compiler/step-1-basic-compiler/build/sysy.tab.cpp"
    break;

  case 7: /* Number: INT_CONST  */
#line 93 "/root/compiler/step-1-basic-compiler/src/sysy.y"
              {
    auto ast = new Number();
    ast->int_const = (yyvsp[0].int_val);
    (yyval.ast_val) = ast;
  }
#line 1142 "/root/compiler/step-1-basic-compiler/build/sysy.tab.cpp"
    break;


#line 1146 "/root/compiler/step-1-basic-compiler/build/sysy.tab.cpp"
...
#line 100 "/root/compiler/step-1-basic-compiler/src/sysy.y"
